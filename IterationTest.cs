...
namespace DotnetIteration
{
    ...
    public class TestClass
    {
        ...
        public void Whispering()
        {
            ...
            Assert.Equal(expected, Iteration.Whispering(data));
        }

        [Fact]
        public void BestDragonOfTheAge()
        {
            var data = new List<Dragon>() {
        new Dragon {Color = "Red Dragon", Health = 350, Age = 1455},
        new Dragon { Color = "Blue Dragon", Health = 325, Age = 1325},
        new Dragon { Color = "Green Dragon", Health = 290, Age = 1555},
        new Dragon { Color = "Black Dragon", Health = 330, Age = 1455},
        new Dragon { Color = "White Dragon", Health = 295, Age = 1655}
        };
            var dragons1455 = new List<string> { "Red Dragon", "Black Dragon" };
            var dragons1555 = new List<string> { "Green Dragon" };
            var dragons2001 = new List<string> { };
            Assert.Equal(dragons1455, Iteration.BestDragonOfTheAge(data, 1455));
            Assert.Equal(dragons1555, Iteration.BestDragonOfTheAge(data, 1555));
            Assert.Equal(dragons2001, Iteration.BestDragonOfTheAge(data, 2001));
        }
